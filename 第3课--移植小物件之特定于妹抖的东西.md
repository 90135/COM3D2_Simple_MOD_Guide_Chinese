...
如果它和某个骨骼重名，那么它就代表了这个顶点组里面的骨骼，对这些顶点的权重

我们刚刚给所有顶点都分配给了 `Bip01 R Hand` 顶点组，且权重是 1
...
（直接在顶点组处指定的顶点，权重默认都是 1，可以在那里调，或者切换到权重编辑模式进行刷选）
...
把 マテリアル変更 和 アタッチ body クリトリス 都删了
